    ...
    return (
        <div className="banner w-full md:w-2/3 px-7 mx-auto relative flex items-center-justify-between">
            <div className="banner-deescription w-full md:w-1/2 p-3">
                ...
                <p className="font-semibold text-4xl text-red-600 py-2">
                    Order your food 
                </p>
                <div className="btn-container">
                    <Button>Order Now</Button>
                    <a href="/menu" className="text-yellow-400 text-3xl hover:text-blue-500 font-bold text-decoration-line px-3">
                        See Menu
                    </a>
                </div>
            </div>
